...
func (in *ObjectStorageLocation) DeepCopyInto(out *ObjectStorageLocation) {
	*out = *in
	...
	if in.EncryptionPublicKeyRef != nil {
		in, out := &in.EncryptionPublicKeyRef, &out.EncryptionPublicKeyRef
		*out = new(corev1.SecretKeySelector)
		(*in).DeepCopyInto(*out)
	}
	if in.EncryptionPrivateKeyRef != nil {
		in, out := &in.EncryptionPrivateKeyRef, &out.EncryptionPrivateKeyRef
		*out = new(corev1.SecretKeySelector)
		(*in).DeepCopyInto(*out)
	}
}
